...
func TestReactionReadsMySQL(t *testing.T) {
	...
	tables := []struct{ name, columns string }{
		...
		{"comment", "uid INT UNSIGNED PRIMARY KEY, reply_uid INT UNSIGNED NOT NULL, post_uid INT UNSIGNED NOT NULL, user_uid INT UNSIGNED NOT NULL, content TEXT NOT NULL, submitted BIGINT UNSIGNED NOT NULL, modified BIGINT UNSIGNED NOT NULL, status TINYINT NOT NULL"},
	...
	for _, statement := range []string{
		...
		fmt.Sprintf("INSERT INTO %scomment VALUES (21, 0, 11, 3, '댓글', 100, 100, 0)", prefix),
